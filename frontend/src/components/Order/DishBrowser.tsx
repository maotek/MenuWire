...
export default function DishBrowser({ dishData, code, table }: DishBrowserProps) {
  ...
  return (
    ...
    // >
    <div>
      {/* <div className="fixed -z-[6] inset-0 pointer-events-none bg-[linear-gradient(180deg,rgba(0,0,0,0.50)_0%,rgba(0,0,0,0.25)_35%,rgba(0,0,0,0.30)_100%)]" /> */}
      ...
      <div className="flex flex-col pt-40 min-h-screen">
        ...
        <header
          className={`fixed top-0 z-10 w-dvw transition-transform duration-300 backdrop-blur-sm bg-[rgb(var(--bg-1))]/70
          ...
          {/* Category picker */}
          <div className="px-4">
            <div className="bg-[rgb(var(--bg-3))]/60 border-0 border-[rgb(var(--border-1))] overflow-x-auto py-1 flex gap-4 px-4">
          ...
          {/* Tag filter */}
          <div className="px-4 border-b-1 border-[rgb(var(--border-1))]">
            {selected && tags.length > 0 && (
              <div className="fade-in overflow-x-auto py-2 flex gap-2">
                <button
        ...
        {modalDish && (
          ...
          >
            <div
              className="flex flex-col scale-fade-in overscroll-contain transform transition-all duration-300 ease-out border-0 border-[rgb(var(--border-1))] p-4 rounded-md w-80 h-[85dvh] bg-body-3 overflow-y-auto bg-[linear-gradient(180deg,rgba(0,0,0,0.20)_0%,rgba(0,0,0,0.25)_35%,rgba(0,0,0,0.30)_100%)]"
